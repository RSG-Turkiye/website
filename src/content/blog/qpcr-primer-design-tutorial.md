...
pubDate: 2022-02-07
description: "(The original tutorial I prepared with Microsoft Sway last year can be found here.) PCR (Polymerase Chain Reaction) is a method widely used in the wet-lab to amplify the specific target sequences (mostly either directly from DNA or converting messenger RNA/mRNA to cDNA, then amplification of the target, also known as RT-PCR). Nowadays, it is"
