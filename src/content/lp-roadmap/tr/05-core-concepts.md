...
resources:
  ...
  - title: "What is a Bioinformatics Pipeline?"
    description: "Tekrarlanabilirlik, iş akışı yöneticileri (Nextflow, Snakemake), konteynerizasyon. Neden analiz adımlarını daha iyisini öğrendikten sonra asla manuel olarak çalıştırmamalısınız."
    tag: Reading
