...
export const ui = {
  en: {
    ...
    "venue.photoCaption": "The METU campus, seen from the MM building. Photograph by Atılım Güneş Baydın, public domain.",
    ...
    "venue.directions.campus.body": "Ring shuttles run inside the campus. The Üçlü Amfi block, which holds U1, U2 and U3, stands beside the Faculty of Arts and Sciences.",
  ...
  tr: {
    ...
    "venue.photoCaption": "ODTÜ kampüsü, MM binasından. Fotoğraf: Atılım Güneş Baydın, kamu malı.",
    ...
    "venue.directions.campus.body": "Kampüs içinde ring servisleri çalışır. U1, U2 ve U3'ü barındıran Üçlü Amfi binası Fen Edebiyat Fakültesi'nin yanındadır.",
