...
export const ui = {
  en: {
    ...
    "abstracts.title": "Abstract and Poster Guidelines",
    "abstracts.subtitle": "What to send, how to format it, and how it is judged.",
    "abstracts.deadline": "Submission deadline",
    "abstracts.dates": "Symposium",
    "abstracts.theme": "Theme",
    "abstracts.deadlineTba": "To be announced",
    "abstracts.submit": "Submit an Abstract",
    "abstracts.soon": "The guidelines for this edition will be published here.",
    ...
    "cta.guidelines": "Read the abstract and poster guidelines before you submit",
  ...
  tr: {
    ...
    "nav.venue": "Mekan",
    "nav.abstracts": "Bildiriler",
    "nav.about": "Hakkında",
    "nav.sponsors": "Sponsorlar",
    "nav.editions": "Geçmiş Sempozyumlar",
    ...
    "abstracts.title": "Bildiri ve Poster Kılavuzu",
    "abstracts.subtitle": "Ne gönderilir, nasıl biçimlendirilir, nasıl değerlendirilir.",
    "abstracts.deadline": "Son gönderim tarihi",
    "abstracts.dates": "Sempozyum",
    "abstracts.theme": "Tema",
    "abstracts.deadlineTba": "Daha sonra duyurulacak",
    "abstracts.submit": "Bildiri Gönder",
    "abstracts.soon": "Bu sürümün kılavuzu burada yayımlanacak.",
    ...
    "cta.guidelines": "Göndermeden önce bildiri ve poster kılavuzunu okuyun",
    ...
    "venue.title": "Mekân",
    "venue.subtitle": "Etkinlik yeri ve ulaşım",
